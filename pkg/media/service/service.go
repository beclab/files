...
func Init() {
	...
	transcodeManager = transcoding.NewTranscodeManager(mediaEncoder, fileSystem, serverConfigurationManager, sessionManager, logger)
...
func CreateApplicationPaths() error {
	...
	if err != nil {
		klog.Infoln("Error creating directory:", err)
		return err
	}
