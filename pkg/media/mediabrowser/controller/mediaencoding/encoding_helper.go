...
var (
	...
	minKerneli915Hang                = version.Version{Major: 5, Minor: 18, Patch: 0}
	maxKerneli915Hang                = version.Version{Major: 6, Minor: 1, Patch: 3}
	minFixedKernel60i915Hang         = version.Version{Major: 6, Minor: 0, Patch: 18}
	minKernelVersionAmdVkFmtModifier = version.Version{Major: 5, Minor: 15, Patch: 0}
	minFFmpegImplictHwaccel          = version.Version{Major: 6, Minor: 0, Patch: 0}
	minFFmpegHwaUnsafeOutput         = version.Version{Major: 6, Minor: 0, Patch: 0}
	minFFmpegOclCuTonemapMode        = version.Version{Major: 5, Minor: 1, Patch: 3}
	minFFmpegSvtAv1Params            = version.Version{Major: 5, Minor: 1, Patch: 0}
	minFFmpegVaapiH26xEncA53CcSei    = version.Version{Major: 6, Minor: 0, Patch: 0}
	minFFmpegReadrateOption          = version.Version{Major: 5, Minor: 0, Patch: 0}
	minFFmpegWorkingVtHwSurface      = version.Version{Major: 7, Minor: 0, Patch: 1}
	minFFmpegDisplayRotationOption   = version.Version{Major: 6, Minor: 0, Patch: 0}
	minFFmpegAdvancedTonemapMode     = version.Version{Major: 7, Minor: 0, Patch: 1}
	minFFmpegAlteredVaVkInterop      = version.Version{Major: 7, Minor: 0, Patch: 1}
	minFFmpegQsvVppTonemapOption     = version.Version{Major: 7, Minor: 0, Patch: 1}
	minFFmpegQsvVppOutRangeOption    = version.Version{Major: 7, Minor: 0, Patch: 1}
	minFFmpegVaapiDeviceVendorId     = version.Version{Major: 7, Minor: 0, Patch: 1}
	minFFmpegQsvVppScaleModeOption   = version.Version{Major: 6, Minor: 0, Patch: 0}
	minFFmpegRkmppHevcDecDoviRpu     = version.Version{Major: 7, Minor: 1, Patch: 1}
