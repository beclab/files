...
struct ListSharePathReq {
    ...
    3: string ShareRelativeUser (api.query="share_relative_user");
    4: string FileType (api.query="file_type");
    5: string Extend (api.query="extend");
    6: string Path (api.query="path");
    7: string ShareType (api.query="share_type");
    8: string Name (api.query="name");
    9: string Permission (api.query="permission");
    10: i64 ExpireIn (api.query="expire_in");
    11: i64 ExpireOver (api.query="expire_over");
    12: optional bool SharedToMe (api.query="shared_to_me");
    13: optional bool SharedByMe (api.query="shared_by_me");
}
