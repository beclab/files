...
ALTER TABLE public.branch OWNER TO seafile_os_framework;
...
ALTER TABLE public.branch_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.garbagerepos OWNER TO seafile_os_framework;
...
ALTER TABLE public.garbagerepos_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.innerpubrepo OWNER TO seafile_os_framework;
...
ALTER TABLE public.innerpubrepo_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.orgquota OWNER TO seafile_os_framework;
...
ALTER TABLE public.orgquota_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.orguserquota OWNER TO seafile_os_framework;
...
ALTER TABLE public.orguserquota_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.repo OWNER TO seafile_os_framework;
...
ALTER TABLE public.repo_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.repofilecount OWNER TO seafile_os_framework;
...
ALTER TABLE public.repofilecount_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.repogroup OWNER TO seafile_os_framework;
...
ALTER TABLE public.repogroup_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.repohead OWNER TO seafile_os_framework;
...
ALTER TABLE public.repohead_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.repohistorylimit OWNER TO seafile_os_framework;
...
ALTER TABLE public.repohistorylimit_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.repoinfo OWNER TO seafile_os_framework;
...
ALTER TABLE public.repoinfo_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.repoowner OWNER TO seafile_os_framework;
...
ALTER TABLE public.repoowner_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.reposize OWNER TO seafile_os_framework;
...
ALTER TABLE public.reposize_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.repotokenpeerinfo OWNER TO seafile_os_framework;
...
ALTER TABLE public.repotokenpeerinfo_id_seq OWNER TO seafile_os_framework;
...
CREATE TABLE IF NOT EXISTS public.GCID (
    id BIGINT NOT NULL PRIMARY KEY DEFAULT nextval('public.gcid_id_seq'),
    repo_id CHAR(36),
    gc_id CHAR(36),
...
--
-- Name: gcid_id_seq; Type: SEQUENCE; Schema: public; Owner: seafile_os_framework
--

CREATE SEQUENCE public.gcid_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: gcid_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
CREATE TABLE IF NOT EXISTS public.LastGCID (
    id BIGINT NOT NULL PRIMARY KEY DEFAULT nextval('public.lastgcid_id_seq'),
    repo_id CHAR(36),
...
--
-- Name: lastgcid_id_seq; Type: SEQUENCE; Schema: public; Owner: seafile_os_framework
--

CREATE SEQUENCE public.lastgcid_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: lastgcid_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: seafile_os_framework
--
...
ALTER TABLE public.repotrash OWNER TO seafile_os_framework;
...
ALTER TABLE public.repotrash_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.repousertoken OWNER TO seafile_os_framework;
...
ALTER TABLE public.repousertoken_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.repovalidsince OWNER TO seafile_os_framework;
...
ALTER TABLE public.repovalidsince_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.seafileconf OWNER TO seafile_os_framework;
...
ALTER TABLE public.seafileconf_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.sharedrepo OWNER TO seafile_os_framework;
...
ALTER TABLE public.sharedrepo_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.systeminfo OWNER TO seafile_os_framework;
...
ALTER TABLE public.systeminfo_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.userquota OWNER TO seafile_os_framework;
...
ALTER TABLE public.userquota_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.usersharequota OWNER TO seafile_os_framework;
...
ALTER TABLE public.usersharequota_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.virtualrepo OWNER TO seafile_os_framework;
...
ALTER TABLE public.virtualrepo_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.webap OWNER TO seafile_os_framework;
...
ALTER TABLE public.webap_id_seq OWNER TO seafile_os_framework;
...
ALTER TABLE public.webuploadtempfiles OWNER TO seafile_os_framework;
...
ALTER TABLE public.webuploadtempfiles_id_seq OWNER TO seafile_os_framework;
...
CREATE INDEX webuploadtempfiles_repoid_idx ON public.webuploadtempfiles USING btree (repo_id);
...
CREATE TABLE IF NOT EXISTS public.RoleUploadRateLimit (
    id BIGINT NOT NULL PRIMARY KEY DEFAULT nextval('public.roleuploadratelimit_id_seq'),
    role VARCHAR(255),
    upload_limit BIGINT
    );
--
-- Name: TABLE RoleUploadRateLimit; Type: OWNER; Schema: public; Owner: seafile_os_framework
--
ALTER TABLE public.RoleUploadRateLimit OWNER TO seafile_os_framework;
--
-- Name: roleuploadratelimit_id_seq; Type: SEQUENCE; Schema: public; Owner: seafile_os_framework
--
CREATE SEQUENCE public.roleuploadratelimit_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
--
-- Name: roleuploadratelimit_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: seafile_os_framework
--
ALTER SEQUENCE public.roleuploadratelimit_id_seq OWNED BY public.RoleUploadRateLimit.id;
--
-- Name: roleuploadratelimit_id_seq; Type: OWNER; Schema: public; Owner: seafile_os_framework
--
ALTER SEQUENCE public.roleuploadratelimit_id_seq OWNER TO seafile_os_framework;
--
-- Name: roleuploadratelimit_role_unique; Type: UNIQUE INDEX; Schema: public; Owner: seafile_os_framework
--
CREATE UNIQUE INDEX roleuploadratelimit_role_unique ON public.RoleUploadRateLimit USING btree (role);
--
...
CREATE TABLE IF NOT EXISTS public.RoleDownloadRateLimit (
    id BIGINT NOT NULL PRIMARY KEY DEFAULT nextval('public.roledownloadratelimit_id_seq'),
    role VARCHAR(255),
    download_limit BIGINT
    );
--
-- Name: TABLE RoleDownloadRateLimit; Type: OWNER; Schema: public; Owner: seafile_os_framework
--
ALTER TABLE public.RoleDownloadRateLimit OWNER TO seafile_os_framework;
--
-- Name: roledownloadratelimit_id_seq; Type: SEQUENCE; Schema: public; Owner: seafile_os_framework
--
CREATE SEQUENCE public.roledownloadratelimit_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
--
-- Name: roledownloadratelimit_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: seafile_os_framework
--
ALTER SEQUENCE public.roledownloadratelimit_id_seq OWNED BY public.RoleDownloadRateLimit.id;
--
-- Name: roledownloadratelimit_id_seq; Type: OWNER; Schema: public; Owner: seafile_os_framework
--
ALTER SEQUENCE public.roledownloadratelimit_id_seq OWNER TO seafile_os_framework;
--
-- Name: roledownloadratelimit_role_unique; Type: UNIQUE INDEX; Schema: public; Owner: seafile_os_framework
--
CREATE UNIQUE INDEX roledownloadratelimit_role_unique ON public.RoleDownloadRateLimit USING btree (role);
--
...
CREATE TABLE IF NOT EXISTS public.UserUploadRateLimit (
    id BIGINT NOT NULL PRIMARY KEY DEFAULT nextval('public.useruploadratelimit_id_seq'),
    "user" VARCHAR(255),
    upload_limit BIGINT
    );
--
-- Name: TABLE UserUploadRateLimit; Type: OWNER; Schema: public; Owner: seafile_os_framework
--
ALTER TABLE public.UserUploadRateLimit OWNER TO seafile_os_framework;
--
-- Name: useruploadratelimit_id_seq; Type: SEQUENCE; Schema: public; Owner: seafile_os_framework
--
CREATE SEQUENCE public.useruploadratelimit_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
--
-- Name: useruploadratelimit_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: seafile_os_framework
--
ALTER SEQUENCE public.useruploadratelimit_id_seq OWNED BY public.UserUploadRateLimit.id;
--
-- Name: useruploadratelimit_id_seq; Type: OWNER; Schema: public; Owner: seafile_os_framework
--
ALTER SEQUENCE public.useruploadratelimit_id_seq OWNER TO seafile_os_framework;
--
-- Name: useruploadratelimit_user_unique; Type: UNIQUE INDEX; Schema: public; Owner: seafile_os_framework
--
CREATE UNIQUE INDEX useruploadratelimit_user_unique ON public.UserUploadRateLimit USING btree ("user");
--
...
CREATE TABLE IF NOT EXISTS public.UserDownloadRateLimit (
    id BIGINT NOT NULL PRIMARY KEY DEFAULT nextval('public.userdownloadratelimit_id_seq'),
    "user" VARCHAR(255),
    download_limit BIGINT
    );
--
-- Name: TABLE UserDownloadRateLimit; Type: OWNER; Schema: public; Owner: seafile_os_framework
--
ALTER TABLE public.UserDownloadRateLimit OWNER TO seafile_os_framework;
--
-- Name: userdownloadratelimit_id_seq; Type: SEQUENCE; Schema: public; Owner: seafile_os_framework
--
CREATE SEQUENCE public.userdownloadratelimit_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
--
-- Name: userdownloadratelimit_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: seafile_os_framework
--
ALTER SEQUENCE public.userdownloadratelimit_id_seq OWNED BY public.UserDownloadRateLimit.id;
--
-- Name: userdownloadratelimit_id_seq; Type: OWNER; Schema: public; Owner: seafile_os_framework
--
ALTER SEQUENCE public.userdownloadratelimit_id_seq OWNER TO seafile_os_framework;
--
-- Name: userdownloadratelimit_user_unique; Type: UNIQUE INDEX; Schema: public; Owner: seafile_os_framework
--
CREATE UNIQUE INDEX userdownloadratelimit_user_unique ON public.UserDownloadRateLimit USING btree ("user");
--
...
CREATE TABLE IF NOT EXISTS public.OrgUserDefaultQuota (
    id BIGINT NOT NULL PRIMARY KEY DEFAULT nextval('public.orguserdefaultquota_id_seq'),
    org_id INTEGER,
    quota BIGINT
    );
--
-- Name: TABLE OrgUserDefaultQuota; Type: OWNER; Schema: public; Owner: seafile_os_framework
--
ALTER TABLE public.OrgUserDefaultQuota OWNER TO seafile_os_framework;
--
-- Name: orguserdefaultquota_id_seq; Type: SEQUENCE; Schema: public; Owner: seafile_os_framework
--
CREATE SEQUENCE public.orguserdefaultquota_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
--
-- Name: orguserdefaultquota_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: seafile_os_framework
--
ALTER SEQUENCE public.orguserdefaultquota_id_seq OWNED BY public.OrgUserDefaultQuota.id;
--
-- Name: orguserdefaultquota_id_seq; Type: OWNER; Schema: public; Owner: seafile_os_framework
--
ALTER SEQUENCE public.orguserdefaultquota_id_seq OWNER TO seafile_os_framework;
--
-- Name: orguserdefaultquota_org_id_unique; Type: UNIQUE INDEX; Schema: public; Owner: seafile_os_framework
--
CREATE UNIQUE INDEX orguserdefaultquota_org_id_unique ON public.OrgUserDefaultQuota USING btree (org_id);
--
...
CREATE TABLE IF NOT EXISTS public.OrgDownloadRateLimit (
    id BIGINT NOT NULL PRIMARY KEY DEFAULT nextval('public.orgdownloadratelimit_id_seq'),
    org_id INTEGER,
    download_limit BIGINT
    );
--
-- Name: TABLE OrgDownloadRateLimit; Type: OWNER; Schema: public; Owner: seafile_os_framework
--
ALTER TABLE public.OrgDownloadRateLimit OWNER TO seafile_os_framework;
--
-- Name: orgdownloadratelimit_id_seq; Type: SEQUENCE; Schema: public; Owner: seafile_os_framework
--
CREATE SEQUENCE public.orgdownloadratelimit_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
--
-- Name: orgdownloadratelimit_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: seafile_os_framework
--
ALTER SEQUENCE public.orgdownloadratelimit_id_seq OWNED BY public.OrgDownloadRateLimit.id;
--
-- Name: orgdownloadratelimit_id_seq; Type: OWNER; Schema: public; Owner: seafile_os_framework
--
ALTER SEQUENCE public.orgdownloadratelimit_id_seq OWNER TO seafile_os_framework;
--
-- Name: orgdownloadratelimit_org_id_unique; Type: UNIQUE INDEX; Schema: public; Owner: seafile_os_framework
--
CREATE UNIQUE INDEX orgdownloadratelimit_org_id_unique ON public.OrgDownloadRateLimit USING btree (org_id);
--
...
CREATE TABLE IF NOT EXISTS public.OrgUploadRateLimit (
    id BIGINT NOT NULL PRIMARY KEY DEFAULT nextval('public.orguploadratelimit_id_seq'),
    org_id INTEGER,
    upload_limit BIGINT
    );
--
-- Name: TABLE OrgUploadRateLimit; Type: OWNER; Schema: public; Owner: seafile_os_framework
--
ALTER TABLE public.OrgUploadRateLimit OWNER TO seafile_os_framework;
--
-- Name: orguploadratelimit_id_seq; Type: SEQUENCE; Schema: public; Owner: seafile_os_framework
--
CREATE SEQUENCE public.orguploadratelimit_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
--
-- Name: orguploadratelimit_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: seafile_os_framework
--
ALTER SEQUENCE public.orguploadratelimit_id_seq OWNED BY public.OrgUploadRateLimit.id;
--
-- Name: orguploadratelimit_id_seq; Type: OWNER; Schema: public; Owner: seafile_os_framework
--
ALTER SEQUENCE public.orguploadratelimit_id_seq OWNER TO seafile_os_framework;
--
-- Name: orguploadratelimit_org_id_unique; Type: UNIQUE INDEX; Schema: public; Owner: seafile_os_framework
--
CREATE UNIQUE INDEX orguploadratelimit_org_id_unique ON public.OrgUploadRateLimit USING btree (org_id);
